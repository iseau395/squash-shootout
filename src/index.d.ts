 ...
 *  @memberof Draw */
  ...
  *  @param {String}  [textAlign='center']
  *  @memberof Draw */
 declare function drawText(text: string, pos: Vector2, size?: number, color?: Color, lineWidth?: number, lineColor?: Color, textAlign?: string): void;
 ...
 declare class TileLayer extends EngineObject {
     ...
     */
      ...
      *  @param {Boolean}  [mirror=0]
      *  @param {Function} drawFunction */
     drawCanvas2D(pos: Vector2, size: Vector2, angle: number | null, mirror: boolean | null, drawFunction: Function): void;
